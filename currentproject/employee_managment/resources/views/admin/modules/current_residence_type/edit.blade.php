                ...
                <div class="container-fluid p-t-20">
                    <div class="row d-flex align-items-center">
                        <div class="col-6 m-b-20">
                            <h3>Edit Current Residence Type</h3>
                        </div>
                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30 add-cards" >
                                <div class="card-header">
                                    <div class="card-title">Edit Current Residence Type Name</div>
                                </div>
                                <form id="current_residence_type_edit" action="{{route('current_residence_type.update',$resitype->uuid)}}" name="current_residence_type_edit"  method="post" enctype="multipart/form-data">
                                    @csrf  
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Current Residence Type</label>
                                                <input type="text" id="current_residence_type_name" name="current_residence_type_name" value="{{$resitype->type}}"  class="form-control form-control-lg" placeholder="Current Residence Type" />
 ...
 @push('scripts')
    <script>
         $(document).ready(function(){
            $("form[name='current_residence_type_edit']").validate({
                rules : {
