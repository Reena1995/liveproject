                ...
                <div class="container-fluid p-t-20">
                    <div class="row d-flex align-items-center">
                        <div class="col-6 m-b-20">
                            <h3>Show Current Residence Type</h3>
                        </div>
                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="current_residence_type_name" name="current_residence_type_name" value="{{$resitype->type}}"  class="form-control form-control-lg" placeholder="current Residence Type name" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer p-t-20 text-right">
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <a href="{{route('current_residence_type.index')}}" class="theme-btn text-white">cancel
                                                            </a>
                                                    </div>
