        ...
        <input type="hidden" name="user_id" value="{{$emp->uuid}}">
            <div id="formId">
                @if(count($educationDetails))
                    ...
                    <!-- @if(!empty(session()->getOldinput()['universityname']))
                            ...
                            <div class="card education mt-3 eduremove educationDetails" id="">
                                <div class="card-body " >
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Universityname</label>
                                                <input type="text" name="{{ 'universityname[]' }}"  value = "{{ old('universityname.'.$index) }}"  class="form-control form-control-lg" placeholder="Enter University Name">
                                                @error('universityname.'.$index)
                                                <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>percentage</label>
                                                <input type="text" name="{{ 'percentage[]' }}"  value = "{{ old('percentage.'.$index) }}"  class="form-control form-control-lg" placeholder="Enter Percentage">
                                                @error('percentage.'.$index)
                                                <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>specialization</label>
                                                <input type="text" name="{{ 'specialization[]' }}"  value = "{{ old('specialization.'.$index) }}"  class="form-control form-control-lg" placeholder="Enter specialization">
                                                @error('specialization.'.$index)
                                                <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>passingyear</label>
                                                <input type="text" name="{{ 'passingyear[]' }}"  value = "{{ old('passingyear.'.$index) }}"  class="form-control form-control-lg" placeholder="Enter passingyear">
                                                @error('passingyear.'.$index)
                                                <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
