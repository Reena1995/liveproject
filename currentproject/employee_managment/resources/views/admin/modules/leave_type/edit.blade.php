                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30 add-cards" >
                                <div class="card-header">
                                    <div class="card-title">Edit Leave Type Name</div>
                                </div>
                                <form id="leave_type_edit" action="{{route('leave_type.update',$leavetype->uuid)}}" name="leave_type_edit_form" method="post" enctype="multipart/form-data">
                                    @csrf  
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Leave Type</label>
                                                <input type="text" id="leave_type_name" name="leave_type_name" value="{{$leavetype->type}}"  class="form-control form-control-lg" placeholder="Enter Leave Type" />
 ...
 @push('scripts')
    <script>
         $(document).ready(function(){
            $("form[name='leave_type_edit_form']").validate({
                rules : {
                    leave_type_name : {
                        required:true,
