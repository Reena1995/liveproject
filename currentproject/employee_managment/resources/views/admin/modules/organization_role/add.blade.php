                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30 add-cards" >
                                <div class="card-header">
                                    <div class="card-title">Add Organization Role Details</div>
                                </div>
                                <form id="organization_role_add" action="{{route('organization_role.add')}}" name="organization_role_add_form"  method="post" enctype="multipart/form-data">
                                    @csrf  
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Organization Role Name</label>
                                                <input type="text" id="organization_role_name"  name="organization_role_name"  class="form-control form-control-lg" placeholder="Enter organization role" />
 ...
 @push('scripts')
    <script>
        $(document).ready(function(){
            $("form[name='organization_role_add_form']").validate({
                rules : {
