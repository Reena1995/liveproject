...
{
    public function empfamilyAdd(Request $request)
    {
        ...
        try{
                ...
                foreach($request->name as $key=> $data){
                    ...
                    if(isset($request->family_uuid[$key]))
                    {
                        ...
                        $family_add->user_id = auth()->user()->id;
    ...
    public function empemergencyAdd(Request $request)
    {
        ...
        try{
            ...
            foreach($request->name as $key => $data){
                ...
                if(isset($request -> emergency_uuid[$key]))
                {
                    ...
                    $emergency_add->user_id = auth()->user()->id; 
