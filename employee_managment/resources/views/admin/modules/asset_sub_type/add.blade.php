...
<section class="admin-content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30 add-cards" >
                                ...
                                <form id="asset_sub_type_add" action="{{route('asset_sub_type.add')}}" name="asset_sub_type_add_form" method="post" enctype="multipart/form-data">
                                    @csrf  
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Asset Sub Type</label>
                                                <input type="text" id="asset_sub_type_name" name="asset_sub_type_name"  class="form-control form-control-lg" placeholder="Enter asset sub type" />
 ...
 <script>
       $(document).ready(function(){
            $("form[name='asset_sub_type_add_form']").validate({
                rules : {
