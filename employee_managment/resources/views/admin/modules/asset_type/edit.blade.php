                        ...
                        <div class="col-lg-10 col-md-12 col-12 m-b-30">
                            ...
                            <div class="card m-b-30 add-cards" >
                                <div class="card-header">
                                    <div class="card-title">Edit Asset Type Name</div>
                                </div>
                                <form id="asset_type_edit"   action="{{route('asset_type.update',$asstype->uuid)}}" name="asset_type_edit_form" method="post" enctype="multipart/form-data">
                                    @csrf  
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                <label>Asset Type</label>
                                                <input type="text" id="asset_type" name="asset_type" value="{{$asstype->type}}"  class="form-control form-control-lg" placeholder="Enter asset type" />
 ...
 @push('scripts')
    <script>
         $(document).ready(function(){
            $("form[name='asset_type_edit_form']").validate({
                rules : {
                    asset_type : {
                        required:true,
