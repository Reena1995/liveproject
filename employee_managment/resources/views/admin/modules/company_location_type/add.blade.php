                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="location_type_name" name="location_type_name"  class="form-control form-control-lg" placeholder="Enter Location Type" />
...
<script>
         $(document).ready(function(){
            $("form[name='company_location_type_add_form']").validate({
                rules : {
