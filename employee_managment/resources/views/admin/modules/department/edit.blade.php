...
<section class="admin-content">
                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text"  id="department_name" name="department_name" value="{{$department->name}}"  class="form-control form-control-lg"  />
 ...
 <script>
         $(document).ready(function(){
            $("form[name='department_edit_form']").validate({
                rules : {
                    department_name : {
                        required:true,
