                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="document_type" name="document_type" value="{{$doctype->type}}"  class="form-control form-control-lg" placeholder="Enter Document Type" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer p-t-20 text-right">
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <a href="{{route('document_type.index')}}" class="theme-btn text-white">cancel
                                                            </a>
                                                    </div>
