                    ...
                    <div class="col-lg-12 m-b-30">
                        ...
                        <div class="card m-b-0">
                            <div class="card-header">
                                <div class="card-title">Education Levels List</div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive-sm">
                                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom-0 w-5">Education Level Name</th>
                                                        <th class="border-bottom-0">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="tablebody">
                                                @if(!empty($edulevel) && $edulevel->count())
                                                    @foreach($edulevel as $index => $edu)
                                                        <tr>
                                                            <td>{{$edulevel->firstItem() + $index}}</td>
                                                            <td>{{$edu->name}}</td>
                                                            <td>
                                                                <a class="btn btn-primary btn-icon btn-sm text-white" href="{{route('education_level.show',$edu->uuid)}}" >
                                                                    <i class="mdi mdi-eye" data-toggle="tooltip" data-original-title="view"></i>
                                                                </a>
                                                            
                                                                <a class="btn btn-primary btn-icon btn-sm text-white" href="{{route('education_level.edit',$edu->uuid)}}" >
                                                                    <i class="mdi mdi-pen" data-toggle="tooltip"
                                                                        data-original-title="Edit"></i>
                                                                </a>
                                                                <a class="btn btn-danger btn-icon btn-sm text-white" href="{{route('education_level.status',$edu->uuid)}}" 
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-6">showing {{$edulevel->firstItem()}} - {{$edulevel->lastitem()}} of  {{$edulevel->total()}}</div>
                                                <div class="col-6"> 
