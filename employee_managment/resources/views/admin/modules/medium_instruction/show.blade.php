                ...
                <div class="container-fluid p-t-20">
                    <div class="row d-flex align-items-center">
                        <div class="col-6 m-b-20">
                            <h3>Show Medium Of Instruction</h3>
                        </div>
                                    ...
                                    <div class="card-body">    
                                        <div class="form-row row">
                                            <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <input type="text" id="medium_instruction_name" name="medium_instruction_name" value="{{$medium->name}}"  class="form-control form-control-lg" placeholder="Enter medium of instruction name" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer p-t-20 text-right">
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <a href="{{route('medium_instruction.index')}}" class="theme-btn text-white">cancel
                                                            </a>
                                                    </div>
