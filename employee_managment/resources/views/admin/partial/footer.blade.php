        ...
        <script src="{{asset('console/assets/js/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>
        <script src="{{asset('console/assets/js/DataTables/datatables.min.js')}}"></script>
