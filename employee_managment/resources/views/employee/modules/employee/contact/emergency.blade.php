<form  id="emp_emergency_add"  name="emp_emergency_add" action="{{route('empContact.emergency.add')}}"  method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="card education mt-3 emergencyadd">
                            ...
                            <div class="card-body " >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                            <label>address</label>
                                            <textarea  class="form-control form-control-lg"  name="address[]" cols="30" placeholder="Enter Details Of disaility">{{ $em->address }}</textarea>
                                        </div>
