...
<form  id="emp_work_add"  name="emp_work_add" action="{{route('empProfessional.empworkAdd.add')}}"  method="post" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="card-body " >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group floating-label col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <textarea  class="form-control form-control-lg"  name="leaving_reason[]" cols="30" placeholder="Enter Details Of disaility">{{ $work->leaving_reason}}</textarea>
